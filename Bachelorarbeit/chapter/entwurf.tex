...
gegeben.
\subsubsection{Model}
Zum Model gehören die eigentlichen Daten der Anwendung. Hier werden Klassen, wie Barcode, UserData,
Order, OrderItem etc. definiert. Hier wird noch eine Klasse definiert, die
Methoden für "`CRUD"'-Operationen (Create Read Update Delete) für das Persistieren der Modeldaten
bietet.
\subsubsection{View}
