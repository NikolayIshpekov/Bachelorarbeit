...
plattformspezifischen Projekte muss lediglich jeweils eine SQLite-Datei zu den Ressourcen hinzugefügt werden. Im gemeinsamen
...
ScanClicked() aus, wenn auf den Scan-Button geklickt wird. Der Scanner wird in einem separaten
