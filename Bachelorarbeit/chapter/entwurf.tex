...
\subsection{Entwurf der Seiten-Navigation der ScanApp}\label{Navigation} 
Beim erstmaligen Starten der App, wird ein Login-Screen angezeigt und der Benutzer wird aufgefordert
sich zu registrieren. Im Falle einer erfolgreichen Registrierung, wird zu der Startansicht
