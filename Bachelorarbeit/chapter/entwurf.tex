\chapter{Entwurf für die Entwicklung mit Xamarin}\label{Entwurf}
...
können. Am Ende dieses Kapitels werden die für die ScanApp benötigten NuGet Packages und Xamarin
...
In der View-Komponente werden die Ansichten der Benutzungsoberfläche der App definiert. 
...
wofür konkret Web Services eingesetzt werden, weil der Zugriff auf die Web Services immer nach
...
begrenzt werden oder es können extra Kosten entstehen, wenn eine Bestimmte Grenze von verbrauchten
...
plattformübergreifend implementieren, das erfolgt in den plattformspezifischen Projekten. Im Sinne von "`Cross-Plattform-Entwicklung"'
wird für solche Fälle ein Interface im gemeinsamen Projekt definiert. Dieses Interface wird dann in den plattformspezifischen Projekten implementiert. Auf
...
hinzugefügt werden. Diese Komponente greift auf native APIs zu - die API zur Steuerung der Kamera
des Geräts, um die Scanner-Funktion zu ermöglichen. 
...
Xamarin Components nicht zum geteilten Projekt hinzugefügt werden können und dadurch entsteht doppelten
