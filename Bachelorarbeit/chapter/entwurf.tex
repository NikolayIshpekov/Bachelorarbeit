...
Änderungen vornehmen, wie z.B. das Definieren von runden Buttons. 
\begin{figure}[!h]
\centering
...
wei die Nutzung der Kamera des Geräts, um die Scanner-Funktion zu ermöglichen Im gemeinsamen Projekt
wird das Interface IScanner.cs definiert (Abb.
\ref{fig:abb28}).
