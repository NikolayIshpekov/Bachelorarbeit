...
Während bspw. bei der Kaufentscheidung
für ein materielles Produkt gemessene oder prognostizierte Werte herangezogen werden können, gibt es
bei Software keine solche Werte. Nach \cite{SE} werden quantifizierte Aussagen über Produkte oder
Entwicklungsprozesse als Metriken bezeichnet. Es ist allerdings keine einfache Aufgabe, geeignete
...
Eclipse oder Xcode unterscheidet. Mit Xamarin.UITest verfügt Xamarin mit einem integrierten Werkzeug zum
Ausführen und Auswertung von automatisierten UI-Tests. Darüber hinaus lassen sich "`open source"'
...
Cross-Plattform-Designer anzubieten.
