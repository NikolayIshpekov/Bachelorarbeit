...
Also Xamarin.iOS benutzt .NET Events mit UIKit Control-Elemente (Buttons, Labels,
...
benutzt iOS Control-Elemente um .NET Ereignisse (Events) auszulösen.\\Beim Markieren eines
Control-Elements (z.B. Button) kann man unter Properties eine eindeutige Bezeichnung für das
...
\caption{Properties eines Control-Elements (Quelle:\cite{XiOS})}
\label{fig:abb18}
\end{figure}
\\Xamarin.iOS unterstützt alle nativen Control-Elemente von Apple. Die können zu einer Xamarin.iOS
Applikation hinzugefügt werden. Das kann mit dem iOS Designer, Xcodes Interface Builder oder
programmatisch passieren. Die meist verwendeten iOS UI Control-Elemente sind:
\begin{itemize}
