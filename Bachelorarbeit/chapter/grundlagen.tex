...
Development Kit (SDK) mit. In dem iOS SDK sind hochwertige Emulatoren für die aktuelle Version
 ...
 Grundlage für die native Entwicklung auf iOS (\cite{LLVM}). Xcode wird kostenlos zur Verfügung
 gestellt.
 Der in Xcode integrierte Interface-Builder unterstützt das Drag-and-drop-Verfahren und macht die Gestaltung der Benutzeroberfläche zu einer relativ
...
Verfügung. Ähnlich wie bei Android werden Apps in einer beschränkenden Sandbox ausgeführt und es
...
Geschäftslogik einer Anewendung und steuert den Programmablauf (siehe Abb.\ref{fig:abb10}).
...
Benutzeroberfläche Property Lists bearbeiten kann, ohne sich mit XML Code auseinandersetzen zu
