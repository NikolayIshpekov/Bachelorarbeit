...
\begin{itemize} 
  ...
  \item \textbf{View}. Die View repräsentiert die Benutzerschnittstelle.
...
eigene Daten zugreifen. Die Entwicklung von Applikationen für Android erfolgt nach dem
Model-View-Controller Architekturmuster. Im Folgenden werden die wichtigsten Komponenten einer Android Applikation vorgestellt.
\cite[317]{App4U}
\begin{figure}[!h]
\centering
...
Funktionalität des oder eines Controllers innerhalb der App abbildet. Die ViewController sind
wichtige Bausteine für alle iOS-Apps. Die Verwaltung einer Ansicht erfolgt über einen
ViewController. Es empfiehlt sich, für jeden Dialog einen eigenen ViewController zu nehmen.
