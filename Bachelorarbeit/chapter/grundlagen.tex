...
mobilen Anwendungen ist groß. Von der hochspezialisierten Business-App bis hin zu Game-Apps. 
...
installiert und ausgeführt werden kann. Die Vorteile einer nativen App sind eine gute Performance
...
Eine Business-App oder Enterprise-App ist eine App der Komplexitätsstufe komplexer Apps.
Business-Apps zeichnen sich dadurch aus, dass sie meistens auf Geschäftskunden ausgerichtet sind.
Bei Anwendungen dieser Kategorie ist das Optische nicht so wichtig. Mit solchen Apps wird eine
Optimierung von Geschäftsprozessen gezielt. 
