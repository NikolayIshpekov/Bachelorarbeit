...
\begin{itemize}
  ...
  Betriebssystems Mac OS X und wird mit allen iPhones und iPads ausgeliefert. Da Apple iOS nicht an
  andere Gerätehersteller lizenziert ist die Installation von iOS nur auf Apple-Geräte möglich. Applikationen lassen sich nur durch Download über ein zentrales
  ...
  Sicht des Entwicklers. Im Laufe der Zeit wurde das Betriebssystem und der damit verbundene
  ...
  selbst zu erstellen als auch abzuspielen.
...
\\In diesem Abschnitt wird kurz erläutert wie man für iOS,
Android und Windows Phone native Apps entwickelt.
\begin{figure}[!h]
\centering
\includegraphics[scale = 0.5]{graphics/App_Lifecycle.png}
\caption{App Life-Cycle}
\label{fig:abb5}
\end{figure}
\subsection{iOS}
...
notwendig. Apps für iOS werden in Objective-C und seit kurzem auch mit der von Apple neu eingeführte
Programmiersprache Swift entwickelt.
...
Studio eine integrierte Entwicklungsumgebung zur Verfügung. Im Gegensatz zu Xcode und Eclipse ist
Visual Studio bis auf die funktional beschränkten Express-Versionen kostenpflichtig. Für die
Erstellung von Windows Phone Apps wird die Programmiersprache C\# verwendet. Visual Studio bietet
