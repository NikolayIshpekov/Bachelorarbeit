...
Abb.\ref{fig:abb6}). Alle Kompilationsschritte werden von den Entwicklungswerkzeugen automatisiert,
so dass keine zusätzlichen Arbeitsschritte für den Entwickler anfallen. Jede Anwendung in Android
wird in einer eigenen virtuellen Maschine, die sogenannte Sandbox, ausgeführt. Jede Anwendung ist
somit isoliert von den anderen Apps und kann nur auf ihre eigene Daten zugreifen. Im Folgenden
werden die wichtigsten Komponenten einer Android Applikation vorgestellt.
\cite[317]{App4U}
\begin{figure}[!h]
\centering
...
\begin{itemize}
  \item /res/values\\Hier werden alle einfache Werten abgelegt. Für Übersetzungen gibt es hier Datei
  pro Sprache
  \item /res/layout\\Hier liegen alle definierten Layouts als XML Dateien. Möglicherweise benötigt
  man für unterschiedliche Display Auflösungen unterschiedliche Layoute.
  \item /res/menu\\Hier werden Eigenschaften von Menüeinträgen definiert.
  \item /res/drawable\\Alle App Icons befinden sich in diesem Ordner, der wiederum in verschiedenen
  Unterordner für die unterschiedlichen Auflösungen gegliedert wird.
\end{itemize}
