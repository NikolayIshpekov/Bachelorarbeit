...
Xamarin Studio. Wie bereits im vorigen Kapitel erläutert, werden die Ansichten der App in Xaml
impementiert. Der Aufbau einer Xaml-Datei ist dem Gerüst eines XML-Dokuments sehr ähnlich.
...
und sich so verhält, wie man es erwartet, also es wird das Optische getestet.\\Ein typischer Weg,
...
werden können. \\Abhilfe kann man sich bei einem Feature von Xamarin, genannt Xamarin Test Cloud,
