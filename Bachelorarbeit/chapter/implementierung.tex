...
\label{fig:abb25}
\end{figure}
\subsection{Xamarin Komponente (Components) und NuGet Packages, die für den Entwurf der App genutzt
wurden}
\begin{itemize}
  \item Components 
  	\begin{itemize}
  		\item ModernHttpClient
  		\item ZXing.Net.Mobile
	\end{itemize}
  \item NuGet Packages 
    \begin{itemize}
  		\item Newtonsoft.Json
  		\item Xam.Plugin.DeviceInfo
	\end{itemize}
\end{itemize}
