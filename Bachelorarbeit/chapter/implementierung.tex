...
In diesem Kapitel werden kurz Feststellungen beschrieben, die während der konkreten Realisierung
...
\newpage
\section{Test}
Ein wichtiger Schritt im Entwicklungszyklus einer App ist das Testen. Es gibt mehrere Arten
...
Bedienoberfläche ordnungsgemäß funktioniert.\\Ein typischer Weg, eine App zu
...
gut wie nie der Fall. Diese Art von Testen, indem ein Mensch die App auf einem realen Gerät nutzt,
...
Bildschirmgröße (es wurde mit einem Tablett Nexus 7 und einem der kleinsten Android Geräten,
...
Wichtig zu beachten ist, dass für alle Punkte aus
\ref{Anforderungsanalyse} getestet werden, so dass am Ende sichergestellt wird, dass die Anforderungen erfüllt sind.
Die Implementierung jedes Anwendungsfalls aus \ref{Anwendungsfälle} sollte in mindestens einem Test
geprüft werden. Es wird mit dem Erfolgsszenario begonnen und danach werden die Sonderfälle ebenfalls
geprüft. In Tabelle \ref{table2} ist zu sehen, wie aus dem Anwendungsfall "`Einmalige
Registrierung"' aus \ref{Registrierung}, zwei Testfälle abgeleitet wurden. Einmal für den
Erfolgsszenario und einem für den Sonderfall, wenn die Eingaben falsch sind. Analog wurden die
Testfälle aus den anderen Anwendungsfällen abgeleitet.

\begin{table}
\begin{tabular}{|l|l|l|l|l|}\hline
 & Anfangszustand & Eingabe/Aktion & Soll-Reaktion der App\\\hline 
1 & User mit Kundenummer 1111  & Eingabe Kd-Nr [1111] & App meldet  \\
 & und PLZ 21107. & Eingabe PLZ [21107]  & "`Ihre Registrierung  \\
 & Die App zeigt den Login Screen an  & [Registrieren] & war erfolgreich"' \\ \hline
2 & User mit Kundenummer 1111  & Eingabe Kd-Nr [2222]  & App meldet \\
 & und PLZ 21107  & Eingabe PLZ [21107]  & "`Ihre Registrierung \\
...
Da es vor allem
bei Android eine große Vielfalt an Geräten gibt, kann das sehr mühsam sein.
