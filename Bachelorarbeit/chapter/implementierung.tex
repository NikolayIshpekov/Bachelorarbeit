...
\begin{itemize}
  ...
  MasterDetailPage in einer NavigationPage nicht möglich ist und die App stürzt ab. Aus diesem Grund
  wird hier folgende Compiler-Direktive zur Fallunterscheidung benutzt:
  \textcolor{gray}{
