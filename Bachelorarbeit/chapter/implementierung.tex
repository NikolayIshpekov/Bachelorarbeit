...
einen Einkaufswagen-Toolbarbutton, den Artikel in den Warenkorb ein.
  \item Im Warenkorb wählt der Benutzer eine der Bestellpositionen aus und fügt durch einen Klick
  auf ein Sternchen-Symbol, den entsprechenden Artikel zu seiner Favoritenliste hinzuzu.
...
sollen permanent gesichert werden können.
